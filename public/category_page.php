        ...
        <div class="container-fluid" style="overflow-y:scroll;">
            ...
            <div class="row flex-row flex-nowrap">
                ...
                <div class="col-md-4" style="height:450px;">
                    <div class="about-col border rounded">
                        <div class="img"> <!-- image div -->
                            <img src="img/team-1.jpg" alt="" style="height:200px;width:100%;" class="img-fluid">
                            <!-- <div class="icon"><i class="ion-ios-eye-outline"></i></div> -->
                        </div>
                        <div class="pl-3 pr-3 mb-1 text-right" style="height:210px;">
                            <!-- Title -->
                            <h5 class="mt-3 text-left mb-2 text-truncate" style="color:black;">Women Power</h5>
                            <!-- Description -->
                            <div class="" style="height:95px;overflow:hidden;">
                                <p class="text-justify font-weight-light">
                                    Nemo enim ipsam voluptatem quia voluptas sit aut odit aut fugit Nemo enim ipsam voluptatem quia voluptas sit aut odit aut fugit Nemo enim ipsam voluptatem quia voluptas sit aut odit aut fugit
                                </p>
                            </div>
                            <!-- Progress bar -->
                            <div class="progress mt-3 text-left" style="height:3px;">
                            ...
                            <div class="mt-2 text-left small">25% funded</div>
                            <hr class="mt-1 mb-2">
                            <a class="text-right small" href="#">View project details ></a>
                        </div>
                    </div>
