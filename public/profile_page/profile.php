...
$query="SELECT * FROM user WHERE user_id=$viewid";
...
if($row['type']==0)
{
  $query1="SELECT * FROM individual WHERE user_id=$viewid";
  ...
  $query1="SELECT * FROM organization WHERE user_id=$viewid";
  $result1=mysqli_query($conn,$query1);
  while($row=mysqli_fetch_assoc($result1)){
    $location=$row['district'];}
...
<body>
<script> $url=window.location.href();</script>
    ...
    <div class="header">
        <div class="container">
            ...
            <?php 
            $query="SELECT type from user WHERE user_id=$viewid";
            $result=mysqli_query($conn,$query);
            $row=mysqli_fetch_assoc($result);
            if($row['type']==0){
              $query1="SELECT image FROM individual WHERE user_id=$viewid";
            ...
            ?>
            <img class="profile-image img-responsive pull-left" style="margin-top:-20px;" <?php echo "src="."../AadhaarImages/".$image ?> alt="James Lee" />
            <div class="profile-content pull-left">
                <h1 class="name"><?php echo $view_user_name; ?></h1>
...
$('#btnYes').click(function() {
    ...
    $('form').submit();
          ...
          <div class="panel-body">
           ...
           //   $query="SELECT * FROM project as p LEFT OUTER JOIN applicant as a ON p.user_id = a.user_id JOIN user AS "
              $query ="SELECT * FROM applicant a, project p,user u WHERE u.user_id=a.user_id AND p.project_id=a.project_id and p.user_id='".$viewid."'";
             ...
             <h2 class="heading">Projects</h2><?php } ?>
                        <div class="content">
                            ...
                            $query1="SELECT * FROM project WHERE user_id='".$viewid."'";
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">  
                          <hr class="divider" />
                            ...
                            $query2="SELECT * FROM donor AS d JOIN project AS p ON d.project_id = p.project_id WHERE d.user_id = '".$viewid."'";
    ...
    $('#example1').DataTable();
                ...
                <?php 
                $query4="SELECT * FROM user as u JOIN individual as i ON u.user_id=i.user_id AND u.user_id='".$viewid."'";
   ...
   <section class="section">
          ...
          <h2 class="heading">My Applications' Status</h2>
            ...
            <tbody>
              <?php
              $query3="SELECT * FROM applicant AS a LEFT OUTER JOIN project AS p ON a.project_id = p.project_id LEFT OUTER JOIN user AS u ON p.user_id=u.user_id WHERE a.user_id = '".$viewid."'";
              $records=mysqli_query($conn,$query3);
              while($result = mysqli_fetch_assoc($records)){

                        echo "<td>".$result['project_title']."</td>";
                        ?><a href="window.location.href" echo "<td>".$result['user_name']."</td>";
                        if($result['application_status']==2)
                          echo "<td class="."bg-danger>Rejected</td>";
                        elseif($result['application_status']==0)
                        ...
                        <div class="content">
                            ...
                            <div class="skillset">
                                ...
                                <div class="item">
                                    <?php
                                    $i=0;
                                    $query2="SELECT * FROM edit WHERE user_id='".$viewid."'";
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                           ...
                           <?php
                                    ...
                                    $i=0;
                                    $query1="SELECT * FROM edit WHERE user_id='".$viewid."'";
                                    $result = mysqli_query($conn,$query1); 
                                    $num_results = mysqli_num_rows($result);
                                   while($row=mysqli_fetch_assoc($result)){
                                      // foreach($row as $value){
                ...
                <aside class="languages aside section">
                    <div class="section-inner">
                        ...
                        <?php
                                    ...
                                    $i=0;
                                    $query1="SELECT languages FROM edit WHERE user_id='".$viewid."'";
                                    $result = mysqli_query($conn,$query1); 
                                    $num_results = mysqli_num_rows($result);
                                   while($row=mysqli_fetch_assoc($result)){
                                      // foreach($row as $value){
